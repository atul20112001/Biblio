...
export default function Banner() {
  return (
    ...
    <>
      <div className="max-w-screen-2xl pb-6 bg-slate-300 container mx-auto md:px-20 px-4 flex flex-col md:flex-row mt-14 mb-2">
        ...
        <button className="btn mt-6 btn-accent">Submit</button>
        </div>
